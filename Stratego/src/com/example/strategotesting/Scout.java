...
/**
 * // -------------------------------------------------------------------------
 * /** This is the scout game piece, note that the move method allows movement
 * in for more than 1 square.
 *
    ...
    extends GamePiece
{
     ...
     *
     * @param x
     *            The x coordinate of the piece's starting position.
     * @param y
     *            The y coordinate of the piece's starting position.
     * @param team
    ...
    /**
     * This method will handle movement for the Scout. For now it will return -1
     * if the user tries to move diagonally or tries to make another illegal
     * move. If the move is successful it will return 0.
     *
     * @param newx
