...
/**
 * // -------------------------------------------------------------------------
 * /** This is the spy game piece class. Note that the battle method is
 * different as a spy can defeat a Marshal. This class could be removed,
 * unfortunately it had legacy code that was removed later it is here now to
 * avoid type errors.
 *
